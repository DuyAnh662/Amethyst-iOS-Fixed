...
- (void)viewDidLoad
{
    ...
    self.javaRuntimes = @{
        @(DEFAULT_JRE): @[@"preference.manage_runtime.default.1165", @"preference.manage_runtime.default.117", @"preference.manage_runtime.default.121", @"preference.manage_runtime.default.125", @"launcher.menu.execute_jar"]
    }.mutableCopy;
    self.sortedJavaVersions = @[@(DEFAULT_JRE)].mutableCopy;

    self.selectedRTTags = @[@"1_16_5_older", @"1_17_newer", @"1_21_newer", @"1_25_newer", @"execute_jar"];
